...
count = 0
for i in range(len(first_history)):
    if first_history[i][0] == second_history[i][0]:
        for k in range(first_history[i][1], first_history[i+1][1]):
            all_points_first.append([first_history[i][0], k])
    elif first_history[i][1] == second_history[i][1]:
        for k in range(first_history[i][0], first_history[i+1][0]):
            all_points_first.append([first_history[i][1], k])
print(all_points_first)
for i in range(len(first_history)):
